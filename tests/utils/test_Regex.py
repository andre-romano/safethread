...
class TestRegex(unittest.TestCase):
    ...
    def test_search_found(self):
        ...
        self.assertTrue(match.group() == '123')
    ...
    def test_find_all(self):
        ...
        self.assertTrue(matches == ['123', '456', '789'])
    ...
    def test_sub(self):
        ...
        self.assertTrue(result == "Replace numbers with numbers")

    def test_subn(self):
        regex = Regex(r'\d+')
        message = "Replace 123 and 456 with numbers"
        result, num_subs = regex.subn('numbers', message)
        self.assertTrue(result == "Replace numbers and numbers with numbers")
        self.assertTrue(num_subs == 2)
